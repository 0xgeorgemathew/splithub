      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-center px-4 pt-16 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-gradient-to-b from-base-100 to-base-200 rounded-2xl shadow-2xl border border-white/10 max-h-[80dvh] flex flex-col overflow-hidden mb-4"
          >
