...
function generateReceiptLines(
  ...
  if (flowState === "success") {
    ...
    lines.push({ id: "d3", text: "================================", type: "divider", delay: 3000 });
    lines.push({ id: "f1", text: "** APPROVED **", type: "success", delay: 3100 });
    lines.push({ id: "f2", text: "================================", type: "divider", delay: 3200 });
    lines.push({ id: "f3", text: "*** THANK YOU ***", type: "header", delay: 3400 });
  }
...
export function POSReceiptPrinter({
  ...
  useEffect(() => {
    const lines = generateReceiptLines(flowState, txHash, networkName, amount, creditsMinted, error);
    setAllLines(lines);
  }, [flowState, txHash, networkName, amount, creditsMinted, error]);
