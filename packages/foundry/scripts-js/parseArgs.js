...
Examples:
  bun run deploy --file DeployYourContract.s.sol --network sepolia
  bun run deploy --network sepolia --keystore my-account
  bun run deploy --file DeployYourContract.s.sol
  bun run deploy
  `);
  process.exit(0);
}
